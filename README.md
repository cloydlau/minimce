...
- 至少需要加载超过 <font color="#dd0000"><b>380kB</b></font> 的网络资源（如果开启插件全家桶，体积将达到 <font color="#dd0000"><b>563kb</b></font>，这还没算上付费插件），外网会很慢，甚至超时
- 有域名检测，会弹窗警告
- 用不同的版本号来适配不同的 Vue 版本，升级 / 切换成本较高
...
如果没有注册 Tiny 账号、或者没有在账号设置中登记域名，界面上会有警告弹出（<font color="#dd0000"><b>即使你使用的是免费的 Core 计划</b></font>）
